...
def args_parser():
    ...
    parser.add_argument('--total_classes', default=200, type=int, help='total classes')
    parser.add_argument('--fg_nc', default=200, type=int, help='the number of classes in first task')
